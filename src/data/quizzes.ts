...
export const quizzes: Quiz[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'q5', text: '"قمبازي" وش المقصود؟', options: ['قميص النوم', 'قفز عالي', 'الصحن المقعر', 'مخادع'], correctAnswer: 3 },
      ...
      { id: 'q10', text: '"أغولك" وش تعني؟', options: ['أستشيرك', 'أخنقك', 'أخبرك', 'أشتكي لك'], correctAnswer: 1 },
